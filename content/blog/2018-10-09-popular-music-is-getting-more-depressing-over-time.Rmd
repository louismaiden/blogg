...
While the previous linear model is useful for considering whether falling valence is a trend that exists beyond mere statistical noise, the non-linear curve below shows greater detail:
```{r, echo = FALSE, warning=FALSE, message = FALSE}
p1 <-  tracks_subset %>% 
