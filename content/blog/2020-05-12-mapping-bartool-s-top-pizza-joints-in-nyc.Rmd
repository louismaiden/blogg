...
pizzaIcon2 <- makeIcon(
  iconUrl = "C:/Users/nyulo/Documents/R/blogg/pizza_pic.png",
  iconWidth = 38, iconHeight = 55,
  iconAnchorX = 12, iconAnchorY = 24
)

starIcon2 <- makeIcon(
  iconUrl = "C:/Users/nyulo/Documents/R/blogg/star_pic.png",
  iconWidth = 38, iconHeight = 55,
  iconAnchorX = 12, iconAnchorY = 24
)
...
#   addMarkers(lng = nyc_pizza$longitude, lat = nyc_pizza$latitude, 
#              popup = paste0("<b>",nyc_pizza$name, ": ", "</b>", nyc_pizza$review_stats_dave_average_score),
#              label = nyc_pizza$name,
#              icon = pizzaIcon,
#              group = "ICON") %>%
#   addEasyButton(easyButton(
#     icon="fa-crosshairs", title="Locate Me",
#     onClick=JS("function(btn, map){ map.locate({setView: true}); }"))) %>% 
#   addSearchFeatures(targetGroups = "ICON", options = searchFeaturesOptions(zoom = 17))
# pizza_map
# 
# 
# saveWidget(pizza_map, file = "pizza_map.html")
