---
title: COVID Impact on the Restaurant Industry at the Zipcode Level
author: Louis Maiden
date: '2020-05-18'
slug: covid-impact-on-the-restaurant-industry-at-the-zipcode-level
categories: []
tags: []
---
...
for(zip_name in nyc_zip_names) {
  ...
  shell %>% 
    select(name, business_status, rating, lat, lng)
