...
Despite these shortcomings, I filtered for dates from 2000 onwards and pushed on. Note that the confidence intervals in the graph below are almost invisible due to the abundance of data points in a given year.
...
The reason for this revolves around the fact that many coaches consider the two-handed backhand as the defacto superior stroke in its combination of power, stability, and comparatively gentler learning curve. The result has led the one-hander to effectively stop being taught.
